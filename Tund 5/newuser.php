<?php
  ...
  // kontrollime kas sünniaeg sisestati
...
} // kui kõik kuupäeva osad on valmis

if(empty($nameError) and empty($surnameError) and empty($birthMonthError) and empty($birthDayError) and empty($genderError) and empty($emailError) and empty($passwordError)) {
